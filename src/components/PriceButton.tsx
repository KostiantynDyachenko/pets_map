...
export default function PriceButton({ price, pricingType }:{price:number, pricingType:string}) {
  return (
    <span className="inline-flex items-center gap-1 h-8 px-2 py-1 pr-[16px] text-xs leading-4 rounded-md cursor-default bg-customGreen/5 border border-customGreen/20 text-black font-bold">
